...
public class AlbedoBuilder {
    ...
    public void run(){
        weapons.add("SPINDLE");
        weapons.add("FESTERING_DESIRE");
        weapons.add("BLACK_SWORD");
        weapons.add("H_OF_DAWN");
        showBestBuilds();
        System.out.println(weapons.size());
    }

    public AlbedoBuilder(ArrayList<Artifact> allArtifacts){
    ...
    public double getDamage(double def, double elementalBonus){

        return 2.4 * def * (1 + elementalBonus);
    ...
    public double[] getArtComboDamage(int[] comboCode, boolean print){
        ...
        if(print)
        {
            System.out.println("Slot\t\tDEF\t\tDEF%\tCRIT RATE\tCRIT DMG\tGeo Bonus\t\tSet Name");
            ...
            for(Artifact artifact : artifacts)
            {
                ...
                System.out.print("\t" +   padString(artifact.getStat("DEF") + "", " ", 4));
                System.out.print("\t" +   padString(Math.round(artifact.getStat("DEF%") * 10000) / 100.0 + "%", " ", 6));
        ...
        double defPercentSum = getStatSum(artifacts, "DEF%");
        ...
        double newDef = (BASE_DEF) * (1 + defPercentSum);
        newDef += getStatSum(artifacts, "DEF");
        ...
        if(print)
        {
            ...
            System.out.println("\nOverall Stats:");
            System.out.println("DEF\t\t\tCRIT RATE\tCRIT DMG\tGeo Bonus");
            System.out.print(padString(Math.round(newDef   * 100) / 100.0 + "", " ", 8));
    ...
    public void       askWeapon(){
        ...
        System.out.println("1 --> Cinnabar Spindle");
        System.out.println("2 --> Festering Desire");
        System.out.println("3 --> Black Sword");
        System.out.println("4 --> Harbinger of Dawn");
