...
public class XinqiuBuilder {
    ...
    public XinqiuBuilder(ArrayList<Artifact> allArtifacts){
    ...
    public double getDamage(double atk, double elementalBonus){
        ...
        return 1.09 * atk * (1 + elementalBonus);
...
//        if(!setBonuses.contains("4:NOBLESSE_OBLIGE"))
//        {
...
//        }
    ...
    public void       askWeapon(){
        ...
        System.out.println("1 --> Sacrificial");
