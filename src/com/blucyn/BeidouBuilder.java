...
public class BeidouBuilder {
    ...
    // (no artifacts)
    /** DON'T CHANGE THESE !!!! **/
    public double BASE_ATK         = 225;
    public double BASE_CRIT_DMG    = .5;
    public double BASE_CRIT_RATE   = .05;
    public double BASE_ELECTRO_BONUS = 0.24;
    ...
    public BeidouBuilder(ArrayList<Artifact> allArtifacts){
    ...
    public double getDamage(double atk, double elementalBonus){
        ...
        return 1.92 * atk * (1 + elementalBonus);
